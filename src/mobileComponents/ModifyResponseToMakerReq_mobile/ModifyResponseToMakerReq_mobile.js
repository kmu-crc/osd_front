...
const CustomIcon = styled.div`
  ...
  margin-top:10px;
`
class ModifyResponseToMakerReq_mobile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <Wrapper>
        ...
        <ShadowBox>
           ...
           <div className="row flex marginTop3">
              ...
              <div className="fontNomal">{request.title}</div>
           </div>
           <div className="row flex marginTop3">
           ...
           <div className="row flex marginTop3">
              ...
              <div className="fontNomal">{request.location && LocationList[parseInt(request.location, 10)].text}</div>
           </div>
           <div className="row flex marginTop3">
              <div className="label">
                메이커 재판매
              </div>
              <div className="fontNomal">{request.resale <= 0 ? "불가능" : "가능"}</div>
           </div>
        </ShadowBox>
        <ShadowBox>
          ...
          <Button onClick={this.onSubmit} background={"red"} color="white">수정하기</Button>
...
export default ModifyResponseToMakerReq_mobile;
