...
const CustomIcon = styled.div`
  ...
  margin-top:10px;
`
class ResponseToDesignerReq_mobile extends Component {
  constructor(props) {
  super(props);
    this.state = {
      ...
      <React.Fragment>
        ...
        <ShadowBox>
           ...
           <div className="row flex marginTop3">
              ...
              <div className="fontNomal">{detail.nick_name || null}</div>
           </div>
           <div className="row flex marginTop3">
           ...
           <div className="row flex marginTop3">
              ...
              <div className="fontNomal flex alignCenter">
                  {category_level1}
                  {category_level2 ? <CustomIcon width="15" height="15" marginRight="15" marginLeft="15" imgURL={category_icon} /> : null}
           ...
           <div className="row flex marginTop3">
              <div className="label">
                {detail.type === "designer" ?"디자이너 위치": null}
                {detail.type === "maker" ? "메이커 위치" : null}
              </div>
              <div className="fontNomal">{LocationList[parseInt(detail.location, 10) || 15].text}</div>
           </div>
           <div className="row flex marginTop3">
              <div className="label">
                {detail.type === "designer" ?"디자인 소유권": null}
                {detail.type === "maker" ? "제작 소유권" : null}
              </div>
              <div className="fontNomal">{detail.ownership <= 0 ? "의뢰자" : "디자이너"}</div>
           </div>
        </ShadowBox>
        <ShadowBox>
...
export default ResponseToDesignerReq_mobile;
