...
class ModifyRequestToDesigner_mobile extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Wrapper>
          <div className="header">디자인 의뢰 수정</div>
          <ShadowBox>
           ...
           <div className="row flex marginTop3 alignCenter">
              ...
              <div className="fontNomal row">
                <InputText onChange={this.onChangeTitle} className="title-input" value={this.state.title || ''} placeholder="제목을 입력하세요."  />
              </div>
           </div>
           <div className="row flex marginTop3 alignCenter">
          ...
          <ShadowBox>
            <div className="row flex">
                ...
                <div className="row">
                  <InputFile_mini width={533} getValue={this.onFileChange} file={{ file_url: this.props.Detail.file_url || '', filename: this.props.Detail.filename || '' }} accept="pdf"  />
                </div>
            </div>
...
} export default ModifyRequestToDesigner_mobile;
{/* <Wrapper>
<div className="header">
  <div className="title">
    <div className="text">디자인 의뢰 수정</div>
  </div>
</div>
