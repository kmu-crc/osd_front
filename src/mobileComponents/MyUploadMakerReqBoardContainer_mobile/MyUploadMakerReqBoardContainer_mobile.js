...
class MyUploadMakerReqBoardContainer_mobile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      page: 0, per: 10,
...
export default connect(mapStateToProps, mapDispatchToProps)(MyUploadMakerReqBoardContainer_mobile);
