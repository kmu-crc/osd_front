...
import ScrollMakerListContainer_mobile from "mobileComponents/ScrollMakerListContainer_mobile/ScrollMakerListContainer_mobile";
...
const target = `maker`;
export default class MakerList_mobile extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    <React.Fragment>
      <Wrapper>
        ...
        <div className="list">
            <ScrollMakerListContainer_mobile sort={sort} cate1={cate1} cate2={cate2} cate3={cate3} history={this.props.history}/>
        </div>
      </Wrapper>
    </React.Fragment>
    );
