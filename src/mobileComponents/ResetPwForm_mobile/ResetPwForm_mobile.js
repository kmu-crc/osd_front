...
class ResetPwForm_mobile extends Component {
      ...
      // <Bg>
        ...
        <form className="centering" onSubmit={this.onSubmit}>
          ...
          <ResetForm onSubmit={this.onSubmit}>
            <div className="row">
            <div className="label" value={this.state.password}>e-mail</div>
            <InputTextBox
                  name="email"
            ...
            <CustomButton onClick={this.onSubmit} height={30} 
                  bgColor={"#FF3838"} borderRadius={10} borderColor={"#FF3838"} fontColor={"white"}>전송</CustomButton>
            </div>
          </ResetForm>
        </div>
...
export default ResetPwForm_mobile;
