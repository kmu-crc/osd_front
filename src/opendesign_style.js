const opendesign_style = {
  ...
  design_margin: {
    ...
    marginBottom: 55,
    marginBottomLast: 55,
    small: { marginRightLast: 85, cols: 1, },
    medium: { marginRightLast: 85, cols: 3, },
    large: { marginRightLast: 85, cols: 4, },
  ...
  designer_margin: {
    ...
    large: { marginRightLast: 0, cols: 5, },
    big: { marginRightLast: 0, cols: 5, },
  },
