...
class Expert extends Component {
  ...
  render() {
    ...
    const img = expert&&expert.imgURL;
    console.log(this.props.data);
    return (
      <Wrapper>
        {/* profile */}
      {this.props.isHotBtn?<HotBtn onClick={()=>this.props.handleTop(expert.uid)}>{this.props.hotLabel}</HotBtn>:null}
      <DeleteHotBtn onClick={()=>this.props.handleDel(expert.uid)}>{this.props.removeLabel}</DeleteHotBtn>
        <Profile face={(img && img.m_img) || expert.m_img || profile} />
        {/* text */}
        <TextWrapper>
