...
class Group extends Component {
    ...
    render() {
        ...
        return (
            <GroupElement >
                {/**클릭 이벤트 */}
                <div onClick={(event) => { this.handleGotoDetail(group.group_id || group.uid, event) }} style={{ cursor: "pointer", position: "absolute", width: "100%", height: "100%", zIndex: "100" }}></div>
                ...
                <div >
                    <div style={{ marginTop: "19px", width: "655px", marginLeft: "17px", fontFamily: "Noto Sans KR" }}>
                        <div style={{
                            height: "40px", lineHeight: "40px", width: "100%",
                    ...
                    <div style={{ backgroundColor: "#EFEFEF", width: "200px", marginTop: "19px", marginLeft: "17px", height: "22px", display: "flex", justifyContent: "space-start", textAlign: "left", lineHeight: "40px", fontSize: "15px", fontWeight: "500", alignItems: "center" }}>
                        <div className="view" style={{ display: "flex", marginRight: "20px" }}>
                            ...
                            <div style={{ color: "#707070", marginLeft: "5px", width: "max-content", fontSize: '15px' }}>{NumberFormat(group.view || 0)}</div>
                        </div>
                        <div className="like" style={{ display: "flex", marginRight: "20px" }}>
                            ...
                            <div style={{ color: "#707070", marginLeft: "5px", width: "max-content", fontSize: '15px' }}>{NumberFormat(group.like || 0)}</div>
                        </div>
                        <div className="child" style={{ display: "flex" }}>
                            ...
                            <div style={{ color: "#707070", marginLeft: "5px", width: "max-content", fontSize: '15px', marginTop: "4px" }}>{NumberFormat(group.design || 0 + group.group || 0)}</div>
                        </div>
                    </div>
                </div>
            </GroupElement>
