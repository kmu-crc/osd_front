...
export default class ExportExcelFile extends React.Component {
    render() {
        return (
            <ExcelFile hideElement={true} filename={`${this.props.group.title}`} fileExtension="xlsx" element={<button style={{ border: "none", marginLeft: "15px", background: "#EFEFEF", color: "red", borderRadius: "15%" }} id="excel-file-donwn">엑셀파일로 다운받기</button>}>
