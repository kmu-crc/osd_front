...
import { FormCheckBox, FormTextArea, FormSelect } from "components/Commons/FormItem";
      ...
      <ValidateForm onSubmit={this.onSubmitHandler} enctype="multipart/form-data">
        <Grid padded={false}>
          ...
          <Grid.Column width={12}>
            <FormField name="about_me" placeholder="자기소개를 적어주세요." label="자기소개" RenderComponent={FormTextArea}/>
            <Form.Group widths={2}>
            ...
            <FormField name="is_designer" placeholder="디자이너로 활동하시겠습니까?" label="디자이너 활동 여부" RenderComponent={FormCheckBox}/>
