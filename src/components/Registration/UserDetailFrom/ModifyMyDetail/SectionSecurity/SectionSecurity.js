        ...
        return(
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{
                ...
                <input type={this.state.showPass==true?"text":"password"} onChange = {this.onChangePassword} value={this.state.password} maxLength="50"
                  style={{
            ...
            <div style={{ marginTop: "55px", display: "flex" }}>
              ...
              <div style={{
                ...
                <input type="password" onChange = {this.onChangeCheckedPassword} value={this.state.passwordcheck} maxLength="50"
                 style={{
                  outline: "none", border: "none",
                  marginLeft: "12px", marginTop: "13px",
                  width: "481.5px", height: "29px", lineHeight: "29px",
