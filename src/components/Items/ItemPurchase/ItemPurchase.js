                ...
                +</Label> */}
                    ...
                    <InputText id="advicebox" value={this.state.message} onChange={this.onChangeMessage} />
                    {
                      this.state.file == null ?
                        <CustomButton id="sendmessage" borderColor="red" width="100" height="50" backgroundColor="white" fontColor="#ff0000"  fontSize="15" onClick={this.writeMessage}><div className="text_">보내기</div></CustomButton>
                        :
                        <React.Fragment>
                          <div>
                            <CustomButton id="sendfile"  borderColor="red" width="100" height="25" marginBottom="5" backgroundColor="white" fontColor="#ff0000" fontSize="15" onClick={this.onSendFile}>전송하기</CustomButton>
                            <CustomButton id="cancelbtn"  borderColor="#707070" width="100" height="25" backgroundColor="white" fontColor="#707070" fontSize="15" onClick={this.onCancelFile}>취소하기</CustomButton>
                          </div>
                        </React.Fragment>
                    }
                  </div>
