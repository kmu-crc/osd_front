...
`;
const MobileDefaultPosition = keyframes`
  0% { left: -170px; }
  100% { left: ${-1 * SLIDE_MENU_WIDTH}px; }
`;
const MobileNavigationAni = styled.div`
  ...
  height: 100%;
  z-index: 902;
  animation-name: ${props => props.sidemenu == null
        ? MobileDefaultPosition
        : props.sidemenu == true
            ? MobileOpenAni : MobileCloseAni};
            ...
            <MobileNavigationAni sidemenu={this.state.sidemenu} >
                <div className="container-wrapper">
                    <NavigationContainerMobile
                        sidemenu={this.state.sidemenu} onClickFolding={this.onClickFoldingSideMenu} />
                </div>
            </MobileNavigationAni>
        </React.Fragment>);
    };
