            ...
            <>
                <MypageHeaderElement>
                    <div style={{ display: 'flex', justifyContent: "space-start", paddingTop: '32px', paddingLeft: '115px' }}>
                        <div className="MynameBox" style = {{width:"115px",height:"29px",fontSize:"20px",fontFamily:"Noto Sans KR",fontWeight:"500",lineHeight:"29px"}}>진아진아진아</div>
                    ...
                    <div className="Descriptions" style={{ display: 'flex', justifyContent: "space-start", paddingTop: '12px', paddingLeft: "419px" }}>
                        <div style={{ fontColor:"#FF0000",position: 'relative', width: "480px", height: "150px", fontSize: '20px', fontWeight: '100', lineHeight: '35PX' }}>
                            패션패션패션{/* {about_me[0]} */}
                        </div>
                        <div style={{ position: 'relative', width: "480px", height: "150px", left: "80px", fontSize: '20px', fontWeight: '100', lineHeight: '35PX' }}>
                            {about_me[1]}
                        </div>
                    </div>
