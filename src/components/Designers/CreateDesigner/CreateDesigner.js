...
class CreateDesigner extends Component {
  ...
  {
    super(props);
    this.state = {change_password: false,nick: true, selected: 0,loading: false,isClickModify:false,}
  ...
  render() {
    ...
    const SectionAdditional_Designer=()=>{
      return (
        <section id="additional_designer" style = {{paddingLeft:"95.5px"}}>
          <div style={{position:"relative",width:"100%",height:"30px",marginTop:"41px",}}>
            <div style={{position:"absolute",top:"0px",
                        fontFamily:"Noto Sans KR",fontSize: "20px", lineHeight: "29px", fontWeight: "500", color: "#707070" }}>디자이너 활동 여부</div> 
            <input type="checkbox" style={{position:"absolute",width:"25px",height:"25px",left:"167px",top:"2px"}}/>
            <div style={{position:"absolute",width:"27px",height:"25px",left:"595px",top:"2px",
                        fontFamily:"Noto Sans KR",fontSize:"17px",lineHeight:"25px",fontWeight:"500",color:"#FF0000"}}>TIP</div>
          </div>
          <div style={{position:"relative",width:"100%",height:"75px"}}>
            <div style={{position:"absolute",width:"540px",height:"100%",left:"595px"
                        ,fontFamily:"Noto Sans KR",fontSize:"17px",fontWeight:"100",color:"#707070",lineHeight:"25px"}}>
              디자이너로서 디자인과 그룹을 만들고 수정할 수 있으며,
              <br/> 디자이너 리스트에 올라가게 됩니다.
              <br/> 추후에 직업에 대한 부가적인 정보를 입력하여 많은 사람들과 소통하게 됩니다.
            </div>
          </div>
          <div style={{position:"relative",width:"100%",height:"450px",marginTop:"68px"}}>
            <div style={{position:"absolute",width:"37px",height:"29px",textAlign:"left",left:"167px",top:"0px",
                        fontSize:"20px",color:"#707070",fontFamily:"Noto Sans KR, Medium"}}>팀</div>
            <input type="text" style={{position:"absolute",left:"222px",top:"0px",width:"505px",height:"56px",border:"none",background:"#EFEFEF"}}/>
            <div style={{position:"absolute",width:"37px",height:"29px",textAlign:"left",left:"167px",top:"102px",
                        fontSize:"20px",color:"#707070",fontFamily:"Noto Sans KR, Medium"}}>경력</div>
            <input type="text" style={{position:"absolute",left:"222px",top:"102px",width:"505px",height:"56px",border:"none",background:"#EFEFEF"}}/>
            <div style={{position:"absolute",width:"37px",height:"29px",textAlign:"left",left:"167px",top:"204px",
                        fontSize:"20px",color:"#707070",fontFamily:"Noto Sans KR, Medium"}}>위치</div>
            <input type="text" style={{position:"absolute",left:"222px",top:"204px",width:"505px",height:"56px",border:"none",background:"#EFEFEF"}}/>
            <div style={{position:"absolute",width:"37px",height:"29px",textAlign:"left",left:"167px",top:"306px",
                        fontSize:"20px",color:"#707070",fontFamily:"Noto Sans KR, Medium"}}>연락</div>
            <input type="text" style={{position:"absolute",left:"222px",top:"306px",width:"505px",height:"56px",border:"none",background:"#EFEFEF"}}/>
          </div>
    ...
    return (<>
      <div style={{ width: "1920px", display: "flex", justifyContent: "center" }}>
        <div id="basic" style={{ marginTop: "45px", width: "196px", height: "37px", fontFamily: "Noto Sans KR", fontSize: "25px", fontWeight: "700", lineHeight: "37px", textAlign: "center", color: "#707070" }}>디자이너 등록하기</div>
      </div>
      ...
      <div style={{ display: "flex", marginTop: "60px", marginBottom: "111px" }}>
        ...
        { this.state.isClickModify&&
          <div style={{ position: "fixed", top: "261px", width: "325px", height: "190px", backgroundColor: "#F5F4F4", borderRadius: "5px" }}>
        ...
        {/* form */}
        <div style={{ width: "1422px", marginLeft:"45px", borderRadius: "5px", border: "8px solid #F5F4F4", paddingTop: "46px" }}>
          <form onSubmit={this.submit}>
            { this.state.isClickModify&&
              ...
              <SectionAdditional />
              <div style={{ marginTop: "106.5px", marginBottom: "67.5px", borderBottom: "5px solid #F5F4F4" }} />
              </React.Fragment>
            }
            <SectionAdditional />
            <div style={{ marginTop: "106.5px", marginBottom: "67.5px", borderBottom: "5px solid #F5F4F4" }} />
            <SectionAdditional_Designer/>
            {/* submit */}
            <div style={{ justifyContent: "flex-end", display: "flex" }}>
              <div style={{ width: "104.5px", height: "44px", borderRadius: "5px", backgroundColor: "#FF0000", paddingTop: "6px", paddingLeft: "15px",marginBottom:"47px", marginRight: "53px" }}>
