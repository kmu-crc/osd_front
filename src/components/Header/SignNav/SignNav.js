...
class SignNav extends Component {
    ...
    render() {
        ...
        return (<>
            ...
            {signin_modal && <SignInModal open={signin_modal} FindPwRequest={this.props.FindPwRequest} signinrequest={this.props.SignInRequest} signin={this.signin} close={this.closeModal} />}
            {isLoggedIn
