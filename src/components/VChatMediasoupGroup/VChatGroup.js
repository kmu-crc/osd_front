...
import Room from './components/GroupRoom';
...
async function run(props) {
  ...
  let roomId = props.group.uid + "g"; // urlParser.query.roomId;
  ...
  console.log("멤!",props, props.member)
...
export default class VChatGroup extends React.Component {
  componentDidMount() {
    domready(async () => {
