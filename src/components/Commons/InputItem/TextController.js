...
export const TextController = props => {
  ...
  useEffect(() => {
    console.log("new editor:", editorRef.current.editor.core)
    console.log("new editor:", props)
  }, [])
  return (<React.Fragment>
    <SunEditor
      ...
      // setContents={props.item}
      ref={editorRef}
      setOptions={{ height: props.height || 200, }}
    />
    <div style={{ width: "max-content", marginLeft: "auto" }}>powerby SunEditor</div>
  </React.Fragment>)
}