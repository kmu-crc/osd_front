    ...
    return (dataListAdded && dataListAdded.length > 0 ?
      <FlexContainer cols={cols} type={type} ref={this.myRef} >
        {dataListAdded.map((item, i) => {
          ...
          return (<FlexBox width={width} marginRight={marginRight} marginBottom={marginBottom} marginRightLast={marginRightLast} marginBottomLast={marginBottomLast} key={i} className={`${last} ${bottom}`}>
