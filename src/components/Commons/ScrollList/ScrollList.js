...
//     if (this.myRef.current && this.myRef.current.getBoundingClientRect().bottom - window.innerHeight <= gap) {
//       hasMore && !loading && this.getLoadData();
//     }
//   };
//   handleScroll = (e) => {
//     this.state.hasMore && this.state.loading === false && this.checkAndGetData();
//   }
