...
`;
const ArrowBelow =
    <svg id="구성_요소_34_2" data-name="구성 요소 34 – 2" xmlns="http://www.w3.org/2000/svg" width="10.85" height="9.435" viewBox="0 0 10.85 9.435">
        <path id="다각형_5" data-name="다각형 5" d="M5.425,0,10.85,9.435H0Z" transform="translate(10.85 9.435) rotate(180)" />
    </svg>
        ...
        return (<Wrapper>
            ...
            <div style={{
                ...
                {steps.map((step, index) =>
                    <div key={index}
                        ...
                        <div
                            ...
                            onClick={() => editor &&
                                this.setState({ editstep: true, title: step.title, where: step.uid })}
                        ...
                        {step.cards.map((card, cidx) =>
                            <div key={cidx}
                                ...
                                {/* {card.first_img} */}
                                {card.private === 1 ?
                                    <div style={{ top: "6px", left: "7px", position: "absolute", display: "flex", flexDirection: "row", alignItems: "center" }}>
                                        <img src={new_logo_lock} style={{ width: "15px", height: "15px", }} />
                                        <p style={{ height: "10px", textAlign: "center", fontWeight: "300", fontSize: "7px", lineHeight: "10px", fontFamily: "Spoqa Han Sans Neo", letterSpacing: "0px", color: "#707070" }}>비공개</p>
                                    </div> : null}
                                ...
                                <div style={{
                                    ...
                                    letterSpacing: "0px",
                                    color: "#000000",
                                    backgroundColor: card.first_img ? "rgba(255,255,255,0.25)" : "none",
                                }}>{card.title}</div>
                                <div style={{
                                    marginTop: "66px",
                                    height: "13px",
                                ...
                                <div style={{
                                    ...
                                    letterSpacing: "0px",
                                    color: card.first_img ? "#000" : "#707070",
                                    backgroundColor: card.first_img ? "rgba(255,255,255,0.35)" : "none",
                                }}>{DateFormat(card.update_time)}</div>
                ...
                {editor
                    ? <div className="card">
                        <div
                            onClick={() => this.setState({ newstep: true, more: false, boardId: this.state.boardId })}
                            style={{
                                width: "146px",
                                height: "25px",
                                backgroundColor: "#515151",
