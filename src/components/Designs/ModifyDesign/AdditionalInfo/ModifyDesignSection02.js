...
const Peer_Name = {
  marginTop: "1px", marginLeft: "10px", fontSize: "20px", lineHeight: "29px", textAlign: "left", fontWeight: "500", fontFamily: "Noto Sans KR",
...
const Additional_invite_Search = {
  marginLeft: "52px", width: "645px", height: "56px", backgroundColor: "#EFEFEF", borderRadius: "5px", fontSize: "20px",
  lineHeight: "29px", fontWeight: "500", color: "#707070"
}
const Additional_invite_SearchText = {
  outline: "none", marginLeft: "27px", marginTop: "12px", height: "29px", lineHeight: "29px", width: "451.5px",
...
const Additional_ExplainBox = {
  marginTop: "150.5px", marginLeft: "auto", marginRight: "52px", width: "545px", height: "69px", textAlign: "right", fontWeight: "300", fontSize: "20px",
...
class ModifyDesignSection02 extends Component {
  ...
  render() {
    const Peer = (prop) => {
      const profile = prop.url || noface
      return (<div style={PeerBox}>
        <div style={{ backgroundImage: `url(${profile})`, backgroundColor: "#D6D6D6", width: "30px", height: "30px", borderRadius: "50%" }} />
