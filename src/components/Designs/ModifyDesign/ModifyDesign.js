...
class ModifyDesign extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      isDelete: false, deleteDialog: false, thumbnail: "", designTitle: "", designExplain: "", loading: false, isPossibleNextStep: false, step: 0, /* 0: basics, 1: additional, 2: contents*/ selectedCate1: null,
