...
import CustomOption from 'components/Designs/CreateDesignForm/CreateOption/CustomOption/CustomOption'
                        ...
                        <div className="mainbox">
                            <div className="innerbox add_flex add_fixed white_color add_betweencontent">
                                ...
                                <div className="buttonbox add_flex">
                                    ...
                                    <Button onClick={this.onApplyOptionWindow} width={50} height={30} padding={5} backgroundColor={"#dddddd"}>적용</Button>
                                </div>
                            </div>
                        </div>
