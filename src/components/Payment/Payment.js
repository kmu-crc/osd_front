                    ...
                    <div className="contentsBox">
                        <HeaderBox>
                            <div className="thumbnail">
                                <Thumbnail width={112} height={93} URL={noimg} marginLeft={85}/> 
                            </div>
                            <div className="title">
                                    <div className="name">Lorem Ipsum</div>
                                    <div className="option">[옵션] 옵션옵션옵션옵션</div>
                            </div>
                            <div className="amount"><div>1</div></div>
                            <div className="price"><div>18,000</div></div>
                            <div className="delivery"><div>2,500</div></div>
                        </HeaderBox>
                        ...
                        <InfoBox width={1433} marginTop={28}>
                            ...
                            <div className="contents paddingTop">
                                <div className="row_Box">
                                    <Row>
                                        ...
                                        <div className="row_content font_small">18,000</div>
                                    </Row>
                                    <Row>
                                        <div className="row_label">배송비</div>
                                        <div className="row_content font_small">2,500</div>
                                    </Row>
                                    <Row>
                            ...
                            <div className="contents flex_center border_gray_left">
                                <div className="sub_Box">
                                    ...
                                    <div className="font_big">18,000won</div>
                                </div>
                            </div>
                        </InfoBox>
                            ...
                            <div className="contents">
                                        <div className="row_content">
                                            <CustomButton width={276} height={81} marginBottom={32} fontSize={20} 
                                                            backgroundColor={'#E9E9E9'}><div>신용카드</div></CustomButton>
                                        </div>
                                        <div className="row_content">
                                            <CustomButton width={276} height={81} marginBottom={32} fontSize={20} 
                                                            backgroundColor={'#E9E9E9'}><div>계좌이체</div></CustomButton>
                                        </div>
                                        <div className="row_content">
                                            <CustomButton width={276} height={81} marginBottom={32} fontSize={20} 
                                                            backgroundColor={'#E9E9E9'}><div>무통장 입금</div></CustomButton>
                                        </div>
                            </div>
                        </InfoBox>
                        <div className="payment_button_Box">
                        <CustomButton width={290} height={70} fontSize={20} fontColor={'white'}
                                                            backgroundColor={'#ff0000'}><div>결제하기</div></CustomButton>
                        </div>
                    </div>
                </MainBox>
            </React.Fragment>
