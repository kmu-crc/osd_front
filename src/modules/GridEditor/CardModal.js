                ...
                <CardDialog open={this.props.open} onClose={this.onClose}>
                    ...
                    <div style={{ position: "relative" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", width: "1000px", height: "29px", fontFamily: "Noto Sans KR", fontSize: "20px", color: "#707070", fontWeight: "500", lineHeight: "29px", marginLeft: "52px", marginTop: "29.78px" }}>
                            <div>{card.title}</div>
                            <div style={{ marginRight: "75px" }}>{this.props.editor ? <><i>수정</i></> : ""}</div>
                        </div>
                        {card.first_img &&
                            <div style={{ marginLeft: "52px", marginTop: "29.78px" }}>
                                ...
                                <div style={{}}><img style={{ width: "250px", height: "250px" }} src={card.first_img.m_img} alt="first-image" /></div>
                            </div>}
                        ...
                        <div style={{ border: "1px solid red", width: "1492px", height: "29px", fontFamily: "Noto Sans KR", fontSize: "20px", color: "#707070", fontWeight: "500", lineHeight: "29px", marginLeft: "52px", marginTop: "30.5px", paddingRight: "25px" }}>
                            <div style={{ borderBottom: "1px solid #707070", width: "1400px" }} />
                        </div>
                        <div style={{ border: "1px solid red", fontFamily: "Noto Sans KR", fontSize: "20px", color: "#707070", fontWeight: "500", lineHeight: "29px", marginLeft: "52px", marginTop: "43.5px" }}>
