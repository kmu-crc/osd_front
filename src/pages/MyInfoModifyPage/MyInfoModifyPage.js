...
const category1 = [
    { id: 0, value: "대분류" }, { id: 1, value: "패션" }, { id: 2, value: "제품" },
    ...
    render() {
        return (<>
            <div style={{ width: "1920px", display: "flex", justifyContent: "center" }}>
                <div style={{ marginTop: "45px", width: "196px", height: "37px", fontFamily: "Noto Sans KR", fontSize: "25px", fontWeight: "700", lineHeight: "37px", textAlign: "center", color: "#707070" }}>내 프로필 수정하기</div>
            </div>

            <div>
                <div><div style={{ width: "250px", border: "1px solid red" }}>list</div>margin</div>
                <div>form</div>
            </div>
        </>)
    }
