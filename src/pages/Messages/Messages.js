            ...
            return (
                <div style={{ width: "336px", marginBottom: "30px", display: "flex" }}>
                    ...
                    <div style={{ width: "244px", height: "70px", marginLeft: "22px" }}>
                        <div>
                            <div style={{ position: "absolute", marginLeft: "145px", marginTop: "3px", width: "99px", height: "23px", fontSize: "14px", color: "#707070", textAlign: "left", fontWeight: "300" }}>최근 활동:8분 전</div>
                            <div style={{ width: "123px", height: "29px", fontSize: "17px", color: "#707070", textAlign: "left", fontWeight: "500" }}>진아진아진아</div>
                        </div>
        ...
        return (<>
            ...
            <div style={{ width: "1750px", height: "869px", marginTop: "25px", marginLeft: "85px", marginBottom: "28px", display: "flex" }}>
                <div style={{ width: "445px", backgroundColor: "#EFEFEF", borderRadius: "25px 0 0 25px", paddingLeft: "54px" }}>
                    ...
                    <div style={{ border: "1px solid blue", marginTop: "14.09px", width: "336px", height: "738px", overflowY: "auto" }}>
                ...
                <div style={{ width: "1298px", backgroundColor: "#EFEFEF", borderRadius: "0px 25px 25px 0px", paddingLeft: "27px" }}>
                    ...
                    <div>
                        ...
                        <div style={{ marginRight: "23px", borderTop: "1px solid #707070", display: "flex" }}>
                            <div style={{ width: "1091px", height: "147px", marginTop: "23px", marginRight: "40px" }}>
                                <textarea style={{
                                    outline: "none",
                                    backgroundColor: "#EFEFEF", border: "none", resize: "none", width: "1091px", height: "147px", fontSize: "18px",
                                    lineHeight: "27px", fontWeight: "500", textAlign: "left", color: "#707070"
                                }}>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                                </textarea>
                            </div>
                            <div style={{ width: "117px", height: "170px", backgroundColor: "#FFFFFF", borderRadius: "0 0 25px 0", display: "table" }}><div style={{ display: "table-cell", verticalAlign: "middle", textAlign: "center", width: "68px", height: "33px", fontSize: "18px", cursor: "pointer", lineHeight: "27px", color: "#707070" }}>
                                전송하기
                                </div>
                            </div>
                        </div>
