  ...
  render() {
    ...
    return (<React.Fragment>
      <BannerWrapper width={heroSize === 'l' ? 1920 : heroSize === 'm' ? 1440 : 360} img={heroSize === 'l' ? hero1920 : heroSize === 'm' ? hero1440 : hero360}>
        <Context />
        {/* <LinkWrapper><a href="/tour">이용 가이드 보러가기</a></LinkWrapper> */}
      </BannerWrapper>
      {/* const Textwrapper = styled.div`float: center;margin-top: 60.5px;// margin-bottom: 60px;text-align: center;font-size: 25px;font-family: Noto Sans KR;font-weight: 700;line-height: 37px;color: #FF0000;cursor: default;`;<Textwrapper>인기 디자인</Textwrapper> */}
