                ...
                <div style={{ marginLeft: "157px", marginTop: "100px", width: "1544px", fontFamily: "Noto Sans KR" }}>
                    ...
                    <div style={{ marginTop: "38px", display: "flex" }}>
                        ...
                        <div style={{
                            ...
                            <input type="password" style={{ outline: "none", marginLeft: "27px", marginTop: "12px", height: "29px", lineHeight: "29px", width: "451.5px", border: "none", color: "#707070", backgroundColor: "#EFEFEF" }} placeholder="비밀번호를 입력하세요." />
                        </div>
                    </div>
                    {/* pw verify */}
                    ...
                    <div style={{ marginTop: "51px", display: "flex" }}>
                        ...
                        <div style={{ marginLeft: "98px", marginTop: "4px", width: "505.5px", height: "56px", backgroundColor: "#EFEFEF", borderRadius: "27px" }} >
                            <SelectBox  width="54px" items={category1} />
                        </div>
                    </div>
                    {/* as designer */}
                    <div style={{ marginTop: "69px" }}>
                        <div style={{ width: "157px", height: "29px", fontSize: "20px", lineHeight: "29px", fontWeight: "500", color: "#707070" }}>디자이너 활동 여부</div>
                        <div style={{ marginTop: "24px", marginLeft: "175px", width: "708px", height: "29px", padding: "0px", display: "flex" }}>
                            <Checkbox txt="네, 디자이너로 활동합니다!" />
                        </div>
                    </div>
                    {/* submit */}
                    <div style={{ marginTop: "56px", marginLeft: "1470px", marginBottom: "156px" }}><div style={{ width: "74px", height: "29px", color: "#FF0000", fontSize: "20px", borderBottom: "1.5px solid #FF0000", fontWeight: "500" }}>등록하기</div></div>
                </div>
            </form>
        </>)
    }
