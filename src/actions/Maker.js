...
export function GetMakerTotalCountRequest(cate1, cate2) {
  return (dispatch) => {
    const url = `${host}/maker/list-count/${cate1}/${cate2}`;
    return fetch(url, { headers: { "Content-Type": "application/json" }, method: "GET" })
      .then(res => res.json())
...
export function GetMakerCountRequest(id) {
  return (dispatch) => {
    const url = `${host}/maker/maker-count/${id}`;
    return fetch(url, { headers: { "Content-Type": "application/json" }, method: "GET" })
      .then(res => res.json())
...
//   return (dispatch) => {
//     const url =  `${host}/maker/detail/${id}/items-joined/${page}`;
//     return fetch(url,
...
export function GetLikeInMakerRequest(id, page) {
  return (dispatch) => {
    const url = `${host}/expert/makerDetail/${id}/like/${page}`;
    return fetch(url,
      { headers: { "Content-Type": "application/json" }, method: "GET" })
      .then(res => res.json())
...
export function GetLikeMakerRequest(id, token) {
  return (dispatch) => {
    ...
    const url = `${host}/expert/getLikeMaker/${id}`;
    return fetch(url,
...
export function LikeMakerRequest(id, token) {
  return (dispatch) => {
    dispatch(LikeMaker());
    const url = `${host}/expert/likeMaker/${id}`;
    return fetch(url,
...
export function UnlikeMakerRequest(id, token) {
  return (dispatch) => {
    ...
    const url = `${host}/expert/unlikeMaker/${id}`;
    return fetch(url,
      { headers: { "Content-Type": "application/json", 'x-access-token': token }, method: "post" })
      .then(res => res.json())
