...
class DesignerListContainer_mobile extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        <Wrapper>
          ...
          <div className="header_box">
            ...
            <div className="category_name">{(this_category && this_category.text === "전체" ? "디자이너" : this_category.text) || "디자이너"}&nbsp;({Count})</div>
            <OrderOption_mobile type="designer" order_clicked={this.handleChangeOrderOps} selected={this_order} />
          </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(DesignerListContainer_mobile)
